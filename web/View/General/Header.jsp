    ...
    <nav>
        ...
        <div id="userSession">
            ...
            <ul style="">
                ...
                <li style="height: 96px; background-color: transparent; margin-right: 10px;">
                    <form action="/View/General/logout">
                    <button id="logout" style="margin-top: 25%; padding-right:5px; padding-left: 5px; ">
                ...
                %>
                <li>
                    <%=studente.getNomeStudente()%> <br> <%=studente.getCognomeStudente()%>
                    <br> <%=studente.getMatricola()%> <br> <%=studente.getEmailStudente()%>
                </li>
                <li>
                ...
                %>
                <li>
                    <%=professore.getNomeProfessore()%> <br> <%=professore.getCognomeProfessore()%>
                    <br> <%=professore.getEmailProfessore()%> <br> <%=professore.getUfficioProfessore()%>
                </li>
                <li>
