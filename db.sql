...
CREATE TABLE `prenotazione` (
  ...
  KEY `idProfessor_idx` (`idProfessore`),
  KEY `idStud_idx` (`idStudente`),
  CONSTRAINT `idRicevimento` FOREIGN KEY (`idRicevimento`) REFERENCES `ricevimento` (`idRicevimento`) ON DELETE CASCADE ON UPDATE NO CASCADE,
